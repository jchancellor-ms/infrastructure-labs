#Script taken from the Azure quickstart demo subscription
#https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/demos/imagebuilder-windowsbaseline/scripts/runScript.ps1
#TODO: consider editing thus so that it automatically grabs the latest Azure baseline
